...
export default class ViewInner {
  ...
  private createInner(): void {
    ...
    inner.className = 'range-slider__inner js-range-slider__inner';
    this.el = inner;
  }
  ...
  setPosition(settings: ISettingsTypes): void {
    ...
    const thumbFirst = hiddenTrack.querySelector('.js-range-slider__thumb_first') as HTMLElement;
    ...
    if (settings.type === 'single-horizontal') {
      ...
      const thumbSecond = hiddenTrack.querySelector('.js-range-slider__thumb_second') as HTMLElement;
