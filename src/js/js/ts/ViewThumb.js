...
class ViewThumb {
    ...
    static moveDoubleTypeX(e) {
        ...
        const targetThumb = target.closest('.range-slider__thumb');
        if (!targetThumb)
            return;
        let targetSecondThumb;
        const firstThumb = target.querySelector('.range-slider__thumb_first');
        const secondThumb = target.querySelector('.range-slider__thumb_second');
    ...
    setPosOnClickDoubleTypeX(e) {
        ...
        let movedThumb;
        if (target.classList.contains('range-slider__thumb'))
            return;
    ...
    moveSingleTypeX(e) {
        const target = e.target;
        const track = target.closest('.range-slider');
        const thumb = target.closest('.range-slider__thumb');
        const inner = track.querySelector('.range-slider__inner');
        if (!thumb)
            return;
    ...
    moveDoubleTypeY(e) {
        const target = e.target;
        const track = target.closest('.range-slider');
        const inner = target.querySelector('.range-slider__inner');
        const targetThumb = target.closest('.range-slider__thumb');
        if (!targetThumb)
            return;
        let targetSecondThumb;
        const firstThumb = track.querySelector('.range-slider__thumb_first');
        const secondThumb = track.querySelector('.range-slider__thumb_second');
        if (targetThumb.classList.contains('range-slider__thumb_first')) {
            targetSecondThumb = secondThumb;
        }
        else {
