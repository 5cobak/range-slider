// export defalut class ViewThumb {
...
// 		const inner = e.target.closest('.range-slider').querySelector('.range-slider__inner');
// 		const targetThumb = e.target.closest('.range-slider__thumb');
// 		if (!targetThumb) return;

// 		let targetSecondThumb;
// 		const firstThumb = e.target.closest('.range-slider').querySelector('.range-slider__thumb_first');
// 		const secondThumb = e.target.closest('.range-slider').querySelector('.range-slider__thumb_second');

// 		if (targetThumb.classList.contains('range-slider__thumb_first')) {
// 			targetSecondThumb = e.target.closest('.range-slider').querySelector('.range-slider__thumb_second');
// 		} else {
// 			targetSecondThumb = e.target.closest('.range-slider').querySelector('.range-slider__thumb_first');
// 		}
...
// 		const shiftX = e.pageX - parseInt(getComputedStyle(targetThumb).left);
...
// 			if (targetThumb === firstThumb && targetThumb.getBoundingClientRect().left >= targetSecondThumb.getBoundingClientRect().left) {
// 				targetThumb.style.left = `${parseInt(getComputedStyle(targetSecondThumb).left)}px`;
// 			}
// 			if (targetThumb === secondThumb && targetThumb.getBoundingClientRect().left <= targetSecondThumb.getBoundingClientRect().left) {
// 				targetThumb.style.left = `${parseInt(getComputedStyle(targetSecondThumb).left)}px`;
// 			}
...
// 		if (firstDifference > secondDifference) movedThumb = thumbs[1];
// 		else movedThumb = thumbs[0];
...
// 		const shiftX = e.pageX - thumb.getBoundingClientRect().left;
...
// 		const shiftX = e.pageY - thumb.getBoundingClientRect().top;
...
// 			inner.style.height = getComputedStyle(thumb).top + parseInt(getComputedStyle(thumb).height) / 2;
// 		}
// 	}
...
// 			const halfThumb = parseInt(getComputedStyle(targetThumb).height) / 2;
...
// 			}
// 			/// max position
// 			else if (parseInt(getComputedStyle(targetThumb).top) >= track.offsetHeight - fullHeightThumb) {
// 				targetThumb.style.top = `${track.offsetHeight - fullHeightThumb}px`;
// 			}

// 			if (targetThumb === firstThumb && targetThumb.getBoundingClientRect().top >= targetSecondThumb.getBoundingClientRect().top) {
// 				targetThumb.style.top = `${parseInt(getComputedStyle(targetSecondThumb).top)}px`;
// 			}
// 			if (targetThumb === secondThumb && targetThumb.getBoundingClientRect().top <= targetSecondThumb.getBoundingClientRect().top) {
// 				targetThumb.style.top = `${parseInt(getComputedStyle(targetSecondThumb).top)}px`;
// 			}
