...
class ViewThumb {
  ...
  setPosition(settings: IsettingsTypes): void {
    const track: HTMLElement = this.$el.parentElement;
  ...
  static moveDoubleTypeX(e) {
    const track: HTMLElement = e.target.closest('.range-slider');
    const inner: HTMLElement = e.target
      .closest('.range-slider')
      .querySelector('.range-slider__inner');
    const targetThumb: HTMLElement = e.target.closest('.range-slider__thumb');
    if (!targetThumb) return;
    let targetSecondThumb: HTMLElement;
    const firstThumb: HTMLElement = e.target
      .closest('.range-slider')
      .querySelector('.range-slider__thumb_first');
    const secondThumb: HTMLElement = e.target
      .closest('.range-slider')
  ...
  setPosOnClickSingleTypeX(e): void {
  ...
  setPosOnClickDoubleTypeX(e): void {
    const track = e.target.closest('.range-slider');
    const clientX = e.clientX;
    const thumbs: HTMLElement[] = track.querySelectorAll('.range-slider__thumb');
  ...
  moveSingleTypeX(e): void {
    const track: HTMLElement = e.target.closest('.range-slider');
    const thumb: HTMLElement = e.target.closest('.range-slider__thumb');
    const inner: HTMLElement = track.querySelector('.range-slider__inner');
    if (!thumb) return;
  ...
  setPosOnClickSingleTypeY(e) {
    const track: HTMLElement = e.target.closest('.range-slider');
    const thumb: HTMLElement = track.querySelector('.range-slider__thumb');
    const inner: HTMLElement = track.querySelector('.range-slider__inner');
    moveAt(e.pageY);
    function moveAt(pageY: number) {
      const fullHeightThumb = parseInt(getComputedStyle(thumb).height);
